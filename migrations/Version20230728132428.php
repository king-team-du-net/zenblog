 ...
 */
final class Version20230728132428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ad (id INT NOT NULL, isonhomepageslider_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, rooms INT NOT NULL, enablereviews TINYINT(1) NOT NULL, cover VARCHAR(255) NOT NULL, reference VARCHAR(255) NOT NULL, is_featured TINYINT(1) DEFAULT 0 NOT NULL, is_portfolio TINYINT(1) DEFAULT 0 NOT NULL, state VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_77E0ED58AEA34913 (reference), INDEX IDX_77E0ED58376C51EF (isonhomepageslider_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE content (id INT AUTO_INCREMENT NOT NULL, attachment_id INT DEFAULT NULL, user_id INT DEFAULT NULL, content LONGTEXT NOT NULL, deleted_at DATETIME DEFAULT NULL, excerpt LONGTEXT NOT NULL, is_online TINYINT(1) DEFAULT 0 NOT NULL, published_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, title VARCHAR(128) NOT NULL, slug VARCHAR(128) NOT NULL, views INT DEFAULT NULL, type VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_FEC530A9989D9B62 (slug), INDEX IDX_FEC530A9464E68B (attachment_id), INDEX IDX_FEC530A9A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ad ADD CONSTRAINT FK_77E0ED58BF396750 FOREIGN KEY (id) REFERENCES content (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE booking ADD CONSTRAINT FK_E00CEDDEBF396750 FOREIGN KEY (id) REFERENCES content (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ad DROP FOREIGN KEY FK_77E0ED58BF396750');
        ...
        $this->addSql('ALTER TABLE booking DROP FOREIGN KEY FK_E00CEDDEBF396750');
