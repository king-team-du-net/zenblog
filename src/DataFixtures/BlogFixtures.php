...
final class BlogFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $this->loadPostsCategories($manager);
    ...
    /*
    public function loadPostsCategories(ObjectManager $manager): void
    {
        $categories = [
            1 => [
                'name' => 'Podcasts',
    ...
    */
    ...
    public function loadPostsCategories(ObjectManager $manager): void
    {
        $this->getPostCategoryData('Podcasts', false, 10, 'success', 'fas fa-podcast', $manager);
        $this->getPostCategoryData('Discussions', true, 10, 'danger', 'fab fa-discourse', $manager);
        $this->getPostCategoryData('Astuces', false, 10, 'primary', 'fas fa-exclamation', $manager);
        $this->getPostCategoryData('News', false, 10, 'info', 'fas fa-info', $manager);
        $this->getPostCategoryData('Challenges', true, 10, 'secondary', 'fas fa-chalkboard', $manager);
        $this->getPostCategoryData('Développement', true, 10, 'info', 'fab fa-dev', $manager);
        $this->getPostCategoryData('Web Design', false, 10, 'warning', 'fas fa-image', $manager);
        $this->getPostCategoryData('Text Design', true, 10, 'success', 'fas fa-keyboard', $manager);
    ...
    private function loadPosts(ObjectManager $manager): void
    {
        ...
        $categories = $manager->getRepository(Category::class)->findBy(['isHidden' => false], ['createdAt' => 'DESC']);
    ...
    /**
     * @return array<array{string, string, string, bool, int, string<string>}>
     */
    private function getPostCategoryDatas(): array
    {
        return [
    ...
    private function getPostCategoryData(
        string $name,
        bool $isHidden,
        int $numberOfPosts,
        string $color = null,
