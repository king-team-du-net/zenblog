...
final class AddUserCommandTest extends AbstractCommandTest
{
    ...
    private array $userData = [
        'nickname' => 'robert-doe',
        'password' => 'password',
        'email' => 'robert-doe@yourdomain.com',
        'firstname' => 'Robert',
        'lastname' => 'Doe',
    ];
    ...
    private function assertUserCreated(bool $isAdmin): void
    {
        ...
        $this->assertSame($this->userData['firstname'], $user->getFirstname());
        $this->assertSame($this->userData['lastname'], $user->getLastname());
        $this->assertSame($this->userData['nickname'], $user->getNickname());
