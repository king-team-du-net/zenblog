 ...
 */
final class ArrayTagToStringTransformerTest extends TestCase
{
    /**
    ...
    /**
     * This helper method mocks the real ArrayTagToStringTransformer class to
     ...
     */
    private function getMockedTransformer(array $findByReturnValues = []): ArrayTagToStringTransformer
    {
        ...
        /** @var \PHPUnit\Framework\MockObject\MockObject|TagRepository $tagRepository */
        return new ArrayTagToStringTransformer($tagRepository);
    }
}
